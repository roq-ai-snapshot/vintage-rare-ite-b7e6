...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Vintage Rare Item`}</title>

        <meta
          name="description"
          content="Welcome to Vintage Rare Item - Your one-stop SaaS solution for buying and selling unique, vintage items for your favorite games."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1509281373149-e957c6296406?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aW50YWdlfGVufDB8fHx8MTY5NzUzODgyMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ajeetmestry?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Ajeet Mestry`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Vintage Rare Item - Your one-stop SaaS solution for buying and selling unique, vintage items for your favorite games.`}
            </Text>
            <Box
